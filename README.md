...
- **Personal Session** — 행사 중 개인 촬영을 포함한 야외·스튜디오 등 소규모 촬영입니다. 컬렉션 자체가 한 명 또는 한 팀의 모델 세션 역할을 하며, 사진은 별도 사람 폴더 없이 관리합니다.
...
- 개인 세션은 컬렉션에 저장한 모델명·계정·캐릭터 정보를 상세 헤더와 사진 크레딧에 표시
...
- 촬영 장소 유형과 관련 행사 지정
- Personal Session 컬렉션에 모델명·계정·캐릭터·작품 정보 입력 (개인 세션은 사람 폴더를 만들 필요 없음)
- 드래그&드롭 업로드
...
5. 행사라면 사람별 폴더를 만들고, 개인 세션이라면 컬렉션 정보 수정에서 모델명·계정·캐릭터를 입력한 뒤 사진을 해당 세션에 바로 올립니다.
